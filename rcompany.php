...
<html>
<head>
    <title>Registro de Compañías</title>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header text-center">
                        <h2>Registro de Compañías</h2>
                    </div>
                    <div class="card-body">
                        <form method="POST" action="pcompanyr.php">
                            ...
                            <div class="form-floating py-4">
                                <input type="text" name="direccion" class="form-control" id="floatingDireccion" placeholder="Dirección" required>
